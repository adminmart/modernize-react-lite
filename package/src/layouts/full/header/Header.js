    ...
    <AppBarStyled position="sticky" color="default">
      <ToolbarStyled>
        ...
        <Stack spacing={1} direction="row" alignItems="center">
          <Button variant="contained" color="primary" target="_blank" href="https://adminmart.com/product/modernize-react-mui-dashboard-template/?ref=56#product-demo-section">
            Check Pro Template
          </Button>
          <Profile />
        </Stack>
